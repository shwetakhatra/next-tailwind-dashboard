    ...
    <div className='flex'>
        <div className='fixed w-20 h-screen p-4 bg-white border-r-[1px] flex flex-col justify-between dark:bg-dark'>
            ...
            <div>
                ...
                <Image src='https://gravatar.com/avatar/f3dfc6ef76c40a3071d13839dfb81778?s=400&d=robohash&r=x' alt='https://gravatar.com/avatar/22a271bcbe0ab1f8713d7307b2f0c6ac?s=400&d=robohash&r=x' width={48} height={48} className='rounded-full bg-gray-100' />
            </div>
        </div>
